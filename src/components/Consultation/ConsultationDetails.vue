<template>
  <div class="container">
      ...
      <div class="srcoll_box">
        <div class="info">
          ...
          <div class="bom">
            <div class="bom_list">
              <div class="ws">
                <span>{{details.ServiceTimes}}</span>次
              </div>
              <p>服务次数</p>
            </div>
            <div class="bom_list">
              <div class="ws">
                <span>{{details.PraiseCount}}</span>次
              </div>
              <p>点赞次数</p>
            </div>
          </div>
        ...
        <div class="content">
          ...
          <div class="pt_title">患者评价
            <span>({{searchVal.len}})</span>
          </div>
    ...
    <actionsheet
      ...
      :menus="payment.menu"
      @on-click-menu="paymentFn"
      show-cancel
    ></actionsheet>
    <actionsheet
      v-model="submitYes.value"
      :menus="submitYes.menu"
      @on-click-menu-jfzf="onJfzf"
      show-cancel
    ></actionsheet>
    ...
    <div class="alert_yhxy" v-show="fwxy">
      ...
      <div class="boxs">
        ...
        <p>12.3 本协议中的标题仅为方便而设，在解释本条款时应被忽略，不能作为本协议条款解释的依据。</p>
      </div>
      <div class="btn yes" @click="fwxyFn">同意</div>
      <div class="btn" @click="fwxy=false">拒绝</div>
    </div>
  </div>
</template>
<script>
